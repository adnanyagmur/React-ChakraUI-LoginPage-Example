...
const LoginPage = () => {
    ...
    return (
        <Container>
            ...
            <Container bg="purple.500" borderRadius={30}>
                <SimpleGrid columns={1}>
                    ...
                    <GridItem w='100%' h='4'></GridItem>
                        ...
                        <Grid>
                            <Center>
                                <GridItem>
                                    <Center bg='white' h='50px' color='purple.500' borderRadius={5}>
                                        <Checkbox size='lg' color="purple" margin="3">
                                           Ben robot değilim
                                        </Checkbox>
                                    </Center>
                                </GridItem>
                        ...
                        <Grid>
                            <Center>
                                <GridItem>
                                    <Button bg="white" color="purple.500" size='md' >Giriş yap  <ArrowRightIcon mx='7px' ></ArrowRightIcon></Button>
                                </GridItem>
                            </Center>
                        </Grid>
