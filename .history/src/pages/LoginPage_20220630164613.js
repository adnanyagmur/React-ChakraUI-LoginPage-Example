            ...
            <Container bg="" borderRadius={30}>
                <SimpleGrid columns={1}>
                    ...
                    <FormControl isRequipurple>
                            <FormLabel color="black" htmlFor='email'>TC. ile giriş <Switch colorScheme='red.500' size='lg' /> E-posta ile giriş </FormLabel>
                        </FormControl>
                        <Grid>
                    ...
                    <GridItem w='100%' h='4'></GridItem>
                        ...
                        <Grid>
                            <Center>
                                <GridItem>
                                    <Button bg="red" color="white" size='md' >Giriş yap  <ArrowRightIcon mx='7px' ></ArrowRightIcon></Button>
                                </GridItem>
                            </Center>
                        </Grid>
