...
const LoginPage = () => {
    ...
    return (
        <Container>
            ...
            <Container bg="yellow" borderRadius={30}>
                <SimpleGrid columns={1}>
                    ...
                    <GridItem w='100%' h='4'></GridItem>
                        ...
                        <Grid>
                            <Center>
                                <GridItem>
                                    <Center bg='white' h='50px' color='black' borderRadius={5}>
                        ...
                        <Grid>
                            <Center>
                                <GridItem>
                                    <Button bg="white" color="black" size='md' >Giriş yap  <ArrowRightIcon mx='7px' ></ArrowRightIcon></Button>
                                </GridItem>
                            </Center>
                        </Grid>
