import { Container, Checkbox, Link, Grid, Button, GridItem, Center, Heading, Box, Image,Switch, SimpleGrid, FormControl, FormLabel, Input, FormErrorMessage, FormHelperText } from "@chakra-ui/react";
            ...
            <Container bg="red.500" borderRadius={30}>
                <SimpleGrid columns={1}>
                    ...
                    <FormControl isRequired>
                            <FormLabel color="white" htmlFor='email'>E-posta ile giriş <Switch colorScheme='teal' size='lg' /> TC. ile giriş</FormLabel>
                        </FormControl>
                        <Grid>
                            <GridItem w='100%' h='10'></GridItem>
                        </Grid>
